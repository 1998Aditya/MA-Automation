...
public class WavingToExcel {

    public static String waveRun = "W20251118132700000019"; // ✅ WaveRun input
    public static String EXCEL_PATH = "C:\\Users\\2210420\\IdeaProjects\\Maven\\OOdata.xlsx";
    ...
    private static void processWaveRunData() throws Exception {
        ...
        try (FileInputStream fis = new FileInputStream(EXCEL_PATH);
            ...
            for (String olpnId : olpnIds) {
                ...
                if (!taskId.isEmpty()) {
                    List<TaskDetail> details = fetchTaskDetails(taskId, token);
    ...
    public static List<String> fetchTaskIdsByOlpn(String olpnId, String token) {
    ...
    // ✅ Fetch TaskGroup
    private static String fetchTaskGroup(String taskId, String token) {
        String taskGroup = "";
        try {
            OkHttpClient client = new OkHttpClient();
            MediaType mediaType = MediaType.parse("application/json");
    ...
    private static void writeTaskDetails(Row row, List<TaskDetail> details) {
        int colIndex = 5; // Column F
    ...
    // ✅ Fetch Task Details
    private static List<TaskDetail> fetchTaskDetails(String taskId, String token) {
        ...
        try {
            ...
            if (json.has("data")) {
                ...
                for (JsonElement element : results) {
                    ...
                    details.add(new TaskDetail(itemId, quantity, location));
                }
            }
        } catch (Exception e) {
    ...
    // ✅ Fetch IDs (OLPN)
    public static List<String> fetchIds(String waveRun, String viewName, String attributeId, String token, String componentName, String idKey) {
    ...
    public static String getAuthToken() {
        try {
            ...
            RequestBody body = RequestBody.create(mediaType,
                    "grant_type=password&username=cogs&password=Cogs@123456");
            ...
            if (responseBody == null || !responseBody.trim().startsWith("{")) return null;
