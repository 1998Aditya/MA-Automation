...
//
        ...
        for (String taskGroupId : taskGroups) {
            ...
            do {
                ...
                for (int slot = 1; slot <= 6; slot++) {
                    ...
                    Thread.sleep(3000);
                    DocPathManager.captureScreenshot("Slot",driver);
    ...
    public static void SettingtheTaskGroupfromExcel(String taskGroupId) throws InterruptedException {
        ...
        DocPathManager.captureScreenshot("Task group",driver);
        DocPathManager.saveSharedDocument();
        System.out.println("🔁Task group screenshot done");
        Thread.sleep(3000);
...
//            searchInput1.sendKeys(Transaction);
    ...
    static String WMEnterDynamicCartID() throws InterruptedException {
        ...
        if (inputField != null) {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("cartId",driver);
            DocPathManager.saveSharedDocument();
            System.out.println("🔁cartId screenshot done");
            Thread.sleep(3000);
    ...
    public static void clickTapToConfirmButton2() throws InterruptedException {
        ...
        Thread.sleep(3000);
        DocPathManager.captureScreenshot("Click Confirm",driver);
        DocPathManager.saveSharedDocument();
    ...
    public static boolean Nomoretasksdailogbox() throws InterruptedException {
        try {
            ...
            if (message.getText().contains("No more tasks to assign")) {
                ...
                Thread.sleep(3000);
                DocPathManager.captureScreenshot("Nomoretasks",driver);
                DocPathManager.saveSharedDocument();
    ...
    public static void ScanCartID(String cartId) {
        ...
        try {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("ScanCartID",driver);
            DocPathManager.saveSharedDocument();
    ...
    public static boolean clickOkAlertButton() {
        ...
        try {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("Alert",driver);
            DocPathManager.saveSharedDocument();
...
// Click the button twice using JavaScript
    ...
    public static void Packlocation() {
        ...
        try {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("Packing Location",driver);
            DocPathManager.saveSharedDocument();
    ...
    public static void SourceLocation() {
        ...
        try {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("Source Location",driver);
            DocPathManager.saveSharedDocument();
    ...
    public static void ItemBarcode() throws IOException {
        ...
        try {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("Item ",driver);
            DocPathManager.saveSharedDocument();
    ...
    public static void EnterUnit() {
        ...
        try {
            ...
            Thread.sleep(3000);
            DocPathManager.captureScreenshot("Quantity ",driver);
            DocPathManager.saveSharedDocument();
...
// By header name
    ...
    public static void endcart() throws InterruptedException {
        ...
        Thread.sleep(3000);
        DocPathManager.captureScreenshot("End Cart ",driver);
        DocPathManager.saveSharedDocument();
...
//        toteField.sendKeys(Keys.DELETE);                   // clear
        ...
        Thread.sleep(3000);
        DocPathManager.captureScreenshot("Tote",driver);
        DocPathManager.saveSharedDocument();
