                ...
                for (String step : steps) {
                    ...
                    switch (step) {
                        ...
                        case "step13": {
                            ...
                            try {
                                String basePath = ExcelReaderIB.DOC_FILEPATH;
                                System.out.println("🔍 Attempting merge per TSG_+++ prefix in: " + basePath);
                                DocMergeUtil.mergeByPrefix(basePath, "TST_");   // <-- new utility method
                                System.out.println("✅ Merge attempted for all TSG groups → " + basePath);
                            } catch (Exception e) {
                                System.out.println("❌ Failed to merge docs: " + e.getMessage());
                            }
                            break;

                        }
                        case "step14": {
                            Checkin s14 = new Checkin(driver);
                            s14.execute();
                            break;
                        }
                        ...
                        case "step15": {
                            Thread.sleep(10000);
                            AsnInductComplete s15 = new AsnInductComplete();
                            s15.execute();

                            Thread.sleep(10000);
                            CheckOut s15_1 = new CheckOut(driver);
                            s15_1.execute();
